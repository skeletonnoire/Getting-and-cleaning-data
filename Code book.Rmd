...
1. Data. The data for this project is publicly avaiable from: https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip. Information on the case can also found here: http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones

2. The run_analysis.R script can be found here:https://github.com/skeletonnoire/Getting-and-cleaning-data/blob/master/run_analysis.R along with details on how to run the scrip in the readme.rmd which can be found here https://github.com/skeletonnoire/Getting-and-cleaning-data/blob/master/README.Rmd

2. Basic information: the final dataset - titled 'tidydata' - consists of 180 rows and 69 columns
...
3. The dataset contains the following variable (column) names:
- subject
- activity
